...
class RequirementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create requirement" do
    assert_difference('Requirement.count') do
      post requirements_url, params: { requirement: { importance: @requirement.importance, job_id: @requirement.job_id, level: @requirement.level, name: @requirement.name } }
    end
  ...
  test "should update requirement" do
    patch requirement_url(@requirement), params: { requirement: { importance: @requirement.importance, job_id: @requirement.job_id, level: @requirement.level, name: @requirement.name } }
