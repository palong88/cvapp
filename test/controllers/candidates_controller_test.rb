...
class CandidatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create candidate" do
    assert_difference('Candidate.count') do
      post candidates_url, params: { candidate: { job_id: @candidate.job_id, name: @candidate.name, score: @candidate.score } }
    end
  ...
  test "should update candidate" do
    patch candidate_url(@candidate), params: { candidate: { job_id: @candidate.job_id, name: @candidate.name, score: @candidate.score } }
